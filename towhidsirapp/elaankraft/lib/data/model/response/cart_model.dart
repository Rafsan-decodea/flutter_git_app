...
class CartModel {
  ...
  late String _shopInfo;
  late List<ChoiceOptions> _choiceOptions;
  late List<int> _variationIndexes;
  late double _shippingCost;
  late String _shippingType;
  late int _minimumOrderQuantity;
  late ProductInfo _productInfo;
