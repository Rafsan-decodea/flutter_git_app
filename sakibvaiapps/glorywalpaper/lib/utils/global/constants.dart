...
List<String> randomApitext = ["wallpapers","beatuy","flower","love","animals","space","forest","colors","life"];
Random randomStringKeys = new Random();
String rApiTexts = randomApitext[randomStringKeys.nextInt(randomApitext.length)];
