...
class LocalizationController extends GetxController {
  ...
  Future<int> loadCurrentLanguage() async {
    _locale = Locale(sharedPreferences.getString(AppConstants.languageCode) ?? AppConstants.languages[0].languageCode!,
        sharedPreferences.getString(AppConstants.agentCountryCode) ?? AppConstants.languages[0].countryCode);
  ...
  void saveLanguage(Locale locale) async {
    ...
    sharedPreferences.setString(AppConstants.agentCountryCode, locale.countryCode!);
  }
