           ...
           return AutoScrollTag(
             ...
             child: GetBuilder<AddMoneyController>(
                  ...
                  return InkWell(
                    ...
                    onTap: () async {
                      addMoneyController.updatePaymentMethod(addMoneyController.paymentMethod == (method.gateway ?? "" ) ? null : method.gateway);
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                CustomImageWidget(
                                  image: "${Get.find<SplashController>().configModel?.baseUrls?.gatewayImageUrl}/${method.gatewayImage}",
                                  height: 25, width: 80,
