...
class ConfigModel {
  ConfigModel({
    ...
    this.systemFeature,
    required this.agentSelfRegistration,
  ...
  factory ConfigModel.fromJson(Map<String, dynamic> json) => ConfigModel(
    ...
    selfDelete : int.parse(json["agent_self_delete"].toString()) == 1 ? true: false,
    ...
    customerSendMoneyLimit: CustomerLimit.fromJson(json['agent_send_money_limit']),
    customerAddMoneyLimit: CustomerLimit.fromJson(json['agent_add_money_limit']),
    customerRequestMoneyLimit: CustomerLimit.fromJson(json['agent_send_money_request_limit']),
    customerWithdrawLimit: CustomerLimit.fromJson(json['agent_withdraw_request_limit']),
    systemFeature: SystemFeature.fromJson(json['system_feature']),
    agentSelfRegistration: '${json['agent_self_registration']}'.contains('1'),
