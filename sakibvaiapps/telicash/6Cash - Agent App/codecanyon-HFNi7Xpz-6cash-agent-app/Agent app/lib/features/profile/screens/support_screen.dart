      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text('need_any_help'.tr, style: rubikMedium.copyWith(
            ...
            Padding(
              ...
              child: Text('feel_free_to_contact'.tr, style: rubikRegular.copyWith(
            ...
            if(splashController.configModel!.companyPhone != null)  Padding(
              ...
              child: InkWell(
                ...
                onTap: () async => await launchUrl(Uri.parse('tel://${splashController.configModel!.companyPhone}'), mode: LaunchMode.externalApplication),
                child: Container(
                  padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(Dimensions.radiusSizeExtraSmall),
                    border: Border.all(color: Theme.of(context).secondaryHeaderColor, width: Dimensions.dividerSizeMedium),
                  ),
