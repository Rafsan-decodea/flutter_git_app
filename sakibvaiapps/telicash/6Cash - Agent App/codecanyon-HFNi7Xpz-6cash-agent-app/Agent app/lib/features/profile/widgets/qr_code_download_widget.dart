...
class QrCodeDownloadWidget extends StatelessWidget {
  final String qrCode;
  final String phoneNumber;
  const QrCodeDownloadWidget({Key? key, required this.qrCode, required this.phoneNumber}) : super(key: key);
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        Get.find<SplashController>().configModel!.companyName ?? AppConstants.appName,
