...
class ColorResources {
  ...
  static Color getGreyBaseGray6() {
    return Get.isDarkMode ? Theme.of(Get.context!).cardColor : const Color(0xFFF2F2F7);
  }
  ...
  //card.
   static Color getAddMoneyCardColor() {
    return Get.isDarkMode ? const Color(0xFF76D583) : const Color(0xFFACD9B3);
  }
   static Color getCashOutCardColor() {
    return Get.isDarkMode ? const Color(0xffd58d44) : const Color(0xFFFFCB66);
  }
   static Color getRequestMoneyCardColor() {
    return Get.isDarkMode ? const Color(0xffc084bd) : const Color(0xFFF6BDE9);
  }
   static Color getReferFriendCardColor() {
    return Get.isDarkMode ? const Color(0xff82bada) : const Color(0xFFADE4FD);
  }
   static Color getOthersCardColor() {
    return Get.isDarkMode ? const Color(0xff6266c4) : const Color(0xFFD0C5FF);
   }
  ...
  static Color getTabGrayColor() {
    return Get.isDarkMode ? const Color(0xFF5092b9) : const Color(0xFFb8d6e5);
  }
