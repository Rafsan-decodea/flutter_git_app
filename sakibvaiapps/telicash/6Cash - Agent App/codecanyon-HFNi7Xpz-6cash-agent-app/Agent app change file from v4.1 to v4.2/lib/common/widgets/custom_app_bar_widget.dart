    ...
    return onlyTitle ? Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(title, style: rubikSemiBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge,color: Colors.white),),
      ...
      child: SafeArea(child: Center(child: Row(
        ...
        children: [
          ...
          isSkip ? SizedBox(child: RoundedButtonWidget(
            buttonText: 'skip'.tr, onTap: function, isSkip: true,
          )) : const SizedBox(),
        ],
      ))),
    );
