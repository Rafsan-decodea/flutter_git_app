...
import 'package:six_cash/features/key_verificaiton/widgets/dotted_border_widget.dart';
...
class _KycVerifyScreenState extends State<KycVerifyScreen> {
  ...
  @override
  void initState() {
    Get.find<KycVerifyController>().onInitSelectDropdown();
    super.initState();
  }
            ...
            return SingleChildScrollView(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                CustomDropDownButtonWidget(
                  ...
                  onChanged: (value)=> kycVerifyController.onChangeDropdown(value!),
                ),
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, index){
                      if(index + 1 == kycVerifyController.identityImage.length + 1) {
                        return const DottedBorderWidget();
                      }
