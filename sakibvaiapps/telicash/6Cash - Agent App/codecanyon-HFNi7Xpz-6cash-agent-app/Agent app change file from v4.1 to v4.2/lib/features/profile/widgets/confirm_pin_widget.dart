...
class ConfirmPinWidget extends StatelessWidget {
  ...
  final bool isAuth;
  ConfirmPinWidget({Key? key, this.callBack, this.isAuth = false}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Container(
              ...
              child:PinCodeTextField(
                ...
                Get.find<BottomSliderController>().onChangePinCompletedStatus(value);
              },
        ...
        InkWell(
            onTap: () {
              if(Get.find<BottomSliderController>().isPinCompleted) {
                ...
                Get.find<BottomSliderController>().onChangePinCompletedStatus('');
