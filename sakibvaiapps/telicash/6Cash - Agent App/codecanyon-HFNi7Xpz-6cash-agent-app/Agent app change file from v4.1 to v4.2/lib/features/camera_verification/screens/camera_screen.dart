...
class _CameraScreenState extends State<CameraScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppbarWidget(title: widget.isBarCodeScan ? 'scanner'.tr : 'face_verification'.tr, isSkip: (!widget.isBarCodeScan && true && !widget.fromEditProfile), function: () {
      ...
      body:  Column(children: [
        Flexible(flex: 2, child: Stack(children: [
          ...
          FractionallySizedBox(child: Align(
            alignment: Alignment.center,
            child: DottedBorder(
              strokeWidth: 3,borderType: BorderType.Rect,
              dashPattern: const [10],color: Colors.white,
        ...
        Flexible(flex: 1, child: CameraInstructionWidget(isBarCodeScan: widget.isBarCodeScan)),
      ]),
    );
  }
