...
class ConfirmationDialogWidget extends StatefulWidget {
  ...
  const ConfirmationDialogWidget({Key? key, required this.icon, this.title, required this.description, required this.onYesPressed, this.isAccept = false,required this.passController}) : super(key: key);
