...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    timer = Timer(const Duration(seconds: 4), () {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => StartPages()));
      print("changedpage");
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // splashA4h (114:1638)
        padding:
            EdgeInsets.fromLTRB(22.39 * fem, 14 * fem, 23.5 * fem, 58 * fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(1.11 * fem, 0 * fem, 0 * fem, 127 * fem),
              width: 314 * fem,
              height: 314 * fem,
              child: Image.asset(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(
                  39.61 * fem, 0 * fem, 38.5 * fem, 43 * fem),
              padding:
                  EdgeInsets.fromLTRB(115 * fem, 75 * fem, 115 * fem, 56 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
            ...
            //   margin:
            //       EdgeInsets.fromLTRB(1.11 * fem, 0 * fem, 0 * fem, 0 * fem),
            //   width: 38 * fem,
            //   height: 8 * fem,
            //   child: Image.asset(
