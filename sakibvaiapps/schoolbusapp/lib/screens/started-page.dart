                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/page-1/images/successful-child-with-graduation-cap-backpack-full-books-1.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5*fem, 2.1*fem),
                            width: 17.1*fem,
                            height: 10.7*fem,
                            child: Image.asset(
                          ...
                          Container(
                            // wifieiV (114:1714)
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5*fem, 2.14*fem),
                            width: 15.4*fem,
                            height: 11.06*fem,
                            child: Image.asset(
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 6.54*fem, 0*fem),
                            child: Text(
                              'Get Started',
                              style: SafeGoogleFont (
                                'Titan One',
