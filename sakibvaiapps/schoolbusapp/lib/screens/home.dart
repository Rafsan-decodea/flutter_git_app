          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                padding:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 37.84 * fem),
                width: double.infinity,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          0 * fem, 0 * fem, 3 * fem, 64 * fem),
                      padding: EdgeInsets.fromLTRB(
                          20 * fem, 23 * fem, 20.5 * fem, 11 * fem),
                      width: 425 * fem,
                      height: 408 * fem,
                      decoration: BoxDecoration(
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(
                                      0 * fem, 43 * fem, 103 * fem, 23 * fem),
                                  padding: EdgeInsets.fromLTRB(29.03 * fem,
                                      7.49 * fem, 28.9 * fem, 6.51 * fem),
                                  width: 174 * fem,
                                  height: double.infinity,
                                  decoration: BoxDecoration(
                                    color: Color(0xffffffff),
                        ...
                        child: Stack(
                          children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      padding: EdgeInsets.fromLTRB(26.3 * fem,
                                          18.22 * fem, 0 * fem, 7.78 * fem),
                                      height: double.infinity,
                                      child: Row(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.center,
                            ...
                            Positioned(
                              ...
                              child: Container(
                                padding: EdgeInsets.fromLTRB(
                                    22.8 * fem, 20 * fem, 8.3 * fem, 18 * fem),
                                width: 428 * fem,
                                height: 108 * fem,
                                decoration: BoxDecoration(
                                  image: DecorationImage(
