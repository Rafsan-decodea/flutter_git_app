        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin:
                  EdgeInsets.fromLTRB(6.39 * fem, 0 * fem, 3.5 * fem, 49 * fem),
              width: double.infinity,
              height: 20 * fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(16 * fem, 17 * fem, 16 * fem, 17 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 16 * fem),
              padding:
                  EdgeInsets.fromLTRB(16 * fem, 17 * fem, 8 * fem, 17 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
                border: Border.all(color: Color(0xffcfcfcf)),
                color: Color(0xffffffff),
