        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(12.5*fem, 0*fem, 3.5*fem, 53*fem),
              width: double.infinity,
              height: 20*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
            ...
            Container(
              ...
              height: 116*fem,
              child: Image.asset(
                'assets/page-1/images/unnamed1-removebg-preview-2.png',
                fit: BoxFit.cover,
              ),
            ),
            Container(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(132*fem, 0*fem, 151*fem, 72*fem),
              width: double.infinity,
              child: Row(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 1.99*fem, 35*fem),
              width: double.infinity,
              height: 43.5*fem,
              child: Stack(
                children: [
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(113*fem, 0*fem, 113*fem, 28.66*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
