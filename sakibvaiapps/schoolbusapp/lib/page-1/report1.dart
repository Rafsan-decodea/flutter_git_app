        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(0*fem, 14*fem, 0*fem, 42*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 23.5*fem, 51*fem),
                    height: 21*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Container(
                          // timebrZ (114:2480)
                          margin: EdgeInsets.fromLTRB(0*fem, 1*fem, 34.11*fem, 0*fem),
                          child: Text(
                            '9:41',
                        ...
                        Container(
                          // timehPo (114:2508)
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 274*fem, 1*fem),
                          child: Text(
                            '9:41',
                            textAlign: TextAlign.center,
                            style: SafeGoogleFont (
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0*fem, 4.16*fem, 0*fem, 5.34*fem),
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(23*fem, 0*fem, 24.1*fem, 14*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(36*fem, 0*fem, 222.5*fem, 31*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(17*fem, 0*fem, 23*fem, 30*fem),
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(114*fem, 0*fem, 114*fem, 22*fem),
                    width: double.infinity,
                    height: 41*fem,
                    decoration: BoxDecoration (
                      color: Color(0xffffffff),
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(24*fem, 0*fem, 27*fem, 11*fem),
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(22*fem, 0*fem, 29*fem, 0*fem),
                    padding: EdgeInsets.fromLTRB(9*fem, 7.36*fem, 35.61*fem, 11.33*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                      border: Border.all(color: Color(0xffffffff)),
