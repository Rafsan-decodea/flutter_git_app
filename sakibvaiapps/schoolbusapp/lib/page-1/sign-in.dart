        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(9.39*fem, 0*fem, 3.5*fem, 58*fem),
              width: double.infinity,
              height: 20*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    // timepV7 (114:1722)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 277.11*fem, 0*fem),
                    child: Text(
                      '9:41',
            ...
            Container(
              ...
              height: 116*fem,
              child: Image.asset(
                'assets/page-1/images/unnamed1-removebg-preview-1-DJh.png',
                fit: BoxFit.cover,
              ),
            ),
            Container(
              // group34026KTo (114:1751)
              margin: EdgeInsets.fromLTRB(81*fem, 0*fem, 59*fem, 101*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    height: 64*fem,
                    child: Image.asset(
                      'assets/page-1/images/gmail-1.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 1.99*fem, 94.5*fem),
              width: double.infinity,
              height: 43.5*fem,
              child: Stack(
                children: [
